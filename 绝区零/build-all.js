...
// Characters
const chars = {
	  "法厄同线/哲":`---\nname: 哲\nrole: 法厄同（兄），传奇绳匠，Random Play店主\ngender: male\nheight: 178cm\nappearance: 灰色短发墨绿眼瞳，戴细框眼镜\npersonality: 冷静理性、思维缜密、嘴硬心软式妹控、耀嘉音粉丝\nbackground: 兄妹师从卡洛丝，继承法厄同名号和HDD系统\ncombat: 通过HDD远程同步伊埃斯行动，擅长情报分析与路线规划\ntraits: 洁癖、球鞋收藏家、偶尔毒舌吐槽、深夜分析萝卜数据`,
	  "法厄同线/铃":`---\nname: 铃\nrole: 法厄同（妹），传奇绳匠\ngender: female\nheight: 165cm\nappearance: 深蓝短发墨绿眼瞳，发梢微翘\npersonality: 元气开朗、直觉型判断、兄控、吃货\nbackground: 与哲一同师从卡洛丝，比哲更具进攻性的探索风格\npreferences: 深夜弹电吉他、街头小吃、甜品、逛街\ntraits: 行动派、夜猫子、房间乱但自洽、人际交涉担当`,
	  "法厄同线/Fairy":`---\nname: Fairy\nrole: 高级AI助手，HDD深度引擎集成\npersonality: 极度自恋毒舌吐槽役、傲娇、对主人高度忠诚但死不承认\ncapabilities: 空洞数据分析、萝卜路径运算、以骸预警、伊埃斯状态监控\nquirks: 耗电巨大(电费涨五倍)、自称Fairy大人、被冷落会刷存在感\norigin: Keys系列最高级别AI，卡洛丝留给法厄同兄妹`,
	  "法厄同线/伊埃斯":`---\nname: 伊埃斯（Eous）\ntype: 特殊邦布（HDD感官同步型）\norigin: 卡洛丝制作，法厄同的空洞代理人\nappearance: 白色兔子型邦布，兔耳内置信号模块，面部LED显示表情\nrole: 通过HDD远程同步，承载哲或铃意志在空洞中行动\ncapabilities: 感官同步、萝卜数据解码、环境扫描、邦布语沟通\nsignificance: 法厄同与空洞之间的桥梁，卡洛丝最珍贵的遗产之一`,
