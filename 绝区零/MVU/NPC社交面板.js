...
const panel = {
  ...
  rules: [
    "① 【强制规则·无例外】任何具名登场角色(无论男女、是否主要角色)首次与主角互动时，必须立即 add /NPCs/{名称} 创建完整条目(含基础/关系/性格/着装/私密档案)。禁止以'仅文字刻画''暂不添加''本次未要求'等理由跳过——不创建即视为违规",
