...
const panel = {
  ...
  variables: {
    ...
    "world.天气": { type: "string", default: "晴好·微风", desc: "当前天气与氛围" },
    "world.城市流言": { type: "string", default: "", desc: "绳网热帖/街头传说/路人八卦" },
    "world.绳网活跃度": { type: "string", default: "普通", desc: "当前委托量与紧急程度：清淡/普通/繁忙/爆满" }
  },
  rules: [
